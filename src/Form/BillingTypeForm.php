...
class BillingTypeForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, UserInterface $user = NULL) {
    ...
    $form['billingtype'] = [
      ...
      '#options' => $billingType,
      '#default_value' => $default_billing_type ? $default_billing_type : 'postpaid',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, UserInterface $user = NULL) {
    ...
    $form_state->setRedirect('apigee_monetization.userbillingtype.confirm', ['user' => $user->id(), 'billingtype' => $billingtype_selected]);
