...
/**
 * Trait PaymentFundingModelPropertyAwareDecoratorTrait.
 */
trait PaymentFundingModelPropertyAwareDecoratorTrait {
  ...
  public function getPaymentFundingModel(): ?string {
    return $this->decorated->getPaymentFundingModel();
  }
  ...
  public function setPaymentFundingModel(string $paymentFundingModel): void {
    $this->decorated->setPaymentFundingModel($paymentFundingModel);
  }
