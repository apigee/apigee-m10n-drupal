...
/**
 * Trait ConsumptionPricingTypePropertyAwareDecoratorTrait.
 */
trait ConsumptionPricingTypePropertyAwareDecoratorTrait {
  ...
  public function getConsumptionPricingType(): ?string {
    return $this->decorated->getConsumptionPricingType();
  }
  ...
  public function setConsumptionPricingType(string $consumptionPricingType): void {
    $this->decorated->setConsumptionPricingType($consumptionPricingType);
  }
