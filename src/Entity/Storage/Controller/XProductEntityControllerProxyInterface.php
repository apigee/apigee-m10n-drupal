...
/**
 * Api xproduct storage controller proxy interface.
 */
interface XProductEntityControllerProxyInterface {

  /**
   * Gets all available xproduct for a developer.
   *
   ...
   *   An array of ApiProduct monetization SDK entities.
   *
  ...
  /**
   * Gets all available xproduct for a company.
   *
