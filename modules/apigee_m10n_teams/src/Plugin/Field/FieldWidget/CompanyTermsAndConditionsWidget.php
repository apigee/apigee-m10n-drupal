...
class CompanyTermsAndConditionsWidget extends TermsAndConditionsWidget {
   ...
   *   Teams monetization factory.
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, array $third_party_settings, MonetizationTeamsInterface $team_monetization) {
  ...
  public function validate($element, FormStateInterface $form_state) {
    ...
    if (empty($value)) {
      ...
      $this->team_monetization->acceptLatestTermsAndConditions($this->entity->getCompany()->id());
    }
  }
