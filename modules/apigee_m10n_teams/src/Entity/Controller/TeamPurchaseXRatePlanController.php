...
use Drupal\apigee_m10n\Entity\Controller\PurchaseRatePlanXController;
 ...
 */
class TeamPurchaseXRatePlanController extends PurchaseRatePlanXController {
   ...
   * @throws \Exception
   */
  public function teamPurchaseForm(TeamInterface $team, XRatePlanInterface $xrate_plan) {
    // Create a purchased_plan to pass to the purchased_plan edit form.
    $purchased_plan = PurchasedProduct::create([
      'ratePlan' => $xrate_plan,
      'appgroup' => $team->decorated(),
   ...
   *   The title.
   */
  public function teamTitle(RouteMatchInterface $route_match, XRatePlanInterface $xrate_plan) {
    return $this->title($route_match, NULL, $xrate_plan);
  }
