...
/**
 * Overrides the `xproduct` entity class.
 *
 * This is a class for product bundles that are aware of teams.
 */
class TeamXProduct extends XProduct implements TeamXProductInterface {
   ...
   * {@inheritdoc}
   */
  public static function getAvailablexProductsByTeam($team_id) {
    return \Drupal::entityTypeManager()
      ->getStorage(static::ENTITY_TYPE_ID)
      ->getAvailablexProductByTeam($team_id);
  }
