...
/**
 * Plugin implementation of the 'apigee_top_up_amount_range' widget.
 *
 * @FieldWidget(
 *   id = "apigee_top_up_amount_range",
 *   label = @Translation("Top up amount (range)"),
 *   field_types = {
 *     "apigee_top_up_amount"
 *   }
 * )
 */
class TopUpAmountRangeWidget extends WidgetBase {

  /**
   * {@inheritdoc}
   */
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    $element['#type'] = 'top_up_amount_range';
