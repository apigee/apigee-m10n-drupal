...
class AddCreditConfigFormTest extends AddCreditFunctionalTestBase {
  ...
  protected function setUp(): void {
    ...
    // Enable euro currency so it will be visible in the form.
  ...
  public function testConfigFormUi() {
    $this->drupalGet(Url::fromRoute('apigee_m10n_add_credit.settings.add_credit'));
    ...
    $this->assertCssElementContains('#edit-products', 'US Dollar');
    $this->assertCssElementContains('#edit-products', 'Euro');
    $this->assertSession()->elementNotExists('css', '.edit--usd.dropbutton');
    $this->assertSession()->elementNotExists('css', '.edit--eur.dropbutton');
